...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <img class="rounded-2xl  border-gray-200 shadow-2xl oject-cover w-full h-30 md:h-96 lg:h-50 md:w-40 md:rounded-none md:rounded-s-lg" src="/Reposync-main/src/assets/4.png" alt="">
        <div class="mt-12 ml-6 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-2xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                <a>
                    <img class="rounded-t-xl" src="/Reposync-main/src/assets/1.png" alt="Mission Image" />
                </a>
                <div class="p-5">
            ...
            <!-- Vision Card -->
            <div class="max-w-sm bg-white border border-gray-200 rounded-2xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                <img class="rounded-t-lg" src="/Reposync-main/src/assets/2.png" alt="Vision Image" />
                <div class="p-5">
                    <p class="mb-3 font-mono text-gray-700 dark:text-gray-400 text-justify">
            ...
            <div class="max-w-sm bg-white border-4 border-gray-200 rounded-2xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                <img class="rounded-t-lg w-full" src="/Reposync-main/src/assets/3.png" alt="Vision Image" />
                <div class="p-5">
                    <p class="mb-3 font-mono text-gray-700 dark:text-gray-400 text-justify">
